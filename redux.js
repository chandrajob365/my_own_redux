...
const createStore = (reducer) => {
  ...
  const subscribers = []
  const store = {
    dispatch: (action) => { // Is dispatch a pure function , as its accession global state variable ?
      validateAction(action)
      console.log('{dispatch} before call to reducer state = ', JSON.stringify(state, null, 2))
      state = reducer(state, action)
      console.log('{dispatch} after call to reducer state = ', JSON.stringify(state, null, 2), '\n-----\n')
